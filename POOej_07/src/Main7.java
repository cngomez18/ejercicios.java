...
//        Persona p2 = new Persona("Cookie", 15, "O", 60, 1.50);
//        Persona p3 = new Persona("Muffin", 18, "H", 75, 1.70);
//        Persona p4 = new Persona("Sushi", 20, "M", 50, 1.65);
//        
//        p1.crearPersona();
...
//----------------------------java excceptions------------------------------
        ...
        try{
        Persona pEx = new Persona("cande", edad, "O", 61, 1.63);
         
       
        System.out.println("nyan: "+ pEx.esMayorDeEdad());
       }catch(Exception eo){
             System.out.println("ocuriio una excepcion:"+ eo.toString());
       }finally{
            System.out.println("funco el finally");
        }
    }
    /*
